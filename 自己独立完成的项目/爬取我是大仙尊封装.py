...
def prasme_con(con):
    try:
        ...
        for i in range(len(chatpterlink)):
            ...
            #print(txt_content)
            return chatpternames,chatpter_url,txt_content
    except AssertionError as v:
        raise v

def save_txt(chatpternames,chatpter_url,txt_content):
    try:
...
if __name__=='__main__':
    con=get_content()
    chatpternames,chatpter_url,txt_content=prasme_con(con)
    save_txt(chatpternames,chatpter_url,txt_content)
